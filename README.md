...
This repository contains Slater-Koster files developed by the [Voss group](https://vossgroup.stanford.edu/) for the electronic structure calculations of transition metals, ranging from Scandium (Sc) to Gold (Au). These files are specifically optimized for use with the **DFTB+** code.
